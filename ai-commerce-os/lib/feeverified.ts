...
export const VERIFIED_FEES: VerifiedFee[] = [
  {
    ...
    values: {
      ...
      fee_rate: 0.1,
      // 売上金の振込手数料は一律200円。
      // これは「1回の振込につき200円」であって「1商品につき200円」ではない。
      // まとめて振り込めば1商品あたりの負担は下がるが、
      // 何件まとめるかはこちらの運用次第で確定できない。
      // 利益を多く見せない方向（＝1件ずつ振り込んだ最悪の場合）で200円のまま計上する。
      fixed_fee: 200,
    },
