...
export const DAY_STEPS: DayStep[] = [
  ...
  },
  {
    ...
    time: "11:00",
    title: "お客様として、引いてみる",
    lead: "上の切り替えで「ユーザー側」へ。ガチャ一覧に、いま公開したものが並んでいます。ログインして1回引きます。",
    why: "ここが、このシステムの要です。運営側で公開した内容が、そのままお客様の画面に出ています。作り込んだ別画面ではありません。棚（一覧・賞品・価格・残口数）はログインなしで見え、引くところからログインが要ります。",
    side: "customer",
    hint: "ガチャ一覧 → いま公開したガチャ → 「◯◯ptで引く」（ログインを求められます）。",
    /* ★引いたことを、引いた回数で見ること。
