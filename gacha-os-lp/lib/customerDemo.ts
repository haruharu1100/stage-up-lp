 ...
 *
 * ★数字について（ここを崩さないこと）
 *   このデモは、画面の横に「残数還元率」を出しています。
 *   つまり数字が適当だと、その場でバレます。
 *   次の2つを必ず守ってください。
 *
 *   ① 残っている景品の本数の合計 ＝ 残り口数
 *      1口引けば景品が1つ出るので、これがずれていたら計算が合いません。
 *      （最初これがずれていて、残数還元率が412%と表示されました。
 *        「還元率を管理するシステム」の販売ページでこれは致命的です）
 *
 *   ② 残数還元率が 90〜105% に収まること
