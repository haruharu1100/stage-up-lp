...
/*
  ...
  3) 機能は減らさない。でも、全部を常時見せない。
     ...
     ★2026-08-22：この線を「料金のすぐ下」まで引き上げました。
       金額と始め方（07）まで読んだ人に、
       診断・監視・相場・信号機・RUSH・発送・問い合わせ・管理画面 の
       8セクションをそのまま続けて読ませていました。
       この8つは 05 の触れるデモで既に手を動かしてもらっています。
       いまは 07 の下は「詳しく見る」4つと、FAQ・最後の一言・CTA だけです。

       ★ここから下に、畳まないセクションを足さないこと。
      ...
      <main>
        ...
        {/*
          ★動画は、畳まないこと（2026-08-22 に「詳しく見る」の中から出しました）。
            ...
            つまり、開いた人しか見られませんでした。
            この約40秒は、このページで言っていること
            （AIに伝える → 承認する → お客様が引く → 発送を頼む →
              AIが答え、判断が要る相談は人へ回る → 運営者が返信する →
              その返信がお客様のスマホに届く → 運営画面の数字が動く）
            を、全部まとめて見せている唯一のものです。
            それを、わざわざボタンを押した人だけに見せる理由がありません。

            置き場所は「最初の一言」のすぐ下です。
            言葉で長く説明する前に、まず動いている実物を見せます。
            ここから先の章は、その約40秒を1つずつ詳しく見ていくものになります。
        */}
        <ProductVideo />
        ...
        {/*
          ══════════════════════════════════════════
          ★2026-08-22：金額から下を、全部「詳しく見る」の中へ入れました。
          ══════════════════════════════════════════
            ...
            この8つは、どれも 05 の触れるデモの中で
            もう手を動かして見てもらっています。
            金額まで読み切った人に、同じ話をもう一度
            スクロールさせる理由がありません。

            消してはいません。畳んだだけです。
            検索エンジンにもAIにも本文は読まれますし、
            OsSummary（#rtp / #price / #shipping / #support）や
            フッターのリンクから飛べば、その場所が自動で開きます。
            ★だから ids から id を減らさないこと。減らすとリンクが切れます。

            ここから下に新しいセクションを「畳まずに」足さないこと。
            足したくなったら、まず上の10章のどれかに入らないかを考えること。
          ══════════════════════════════════════════
        */}
        <DetailBlock
          label="自分の場合は、どの構成から始めればよいかを見る"
          note="4つの質問に答えると、STARTER / STANDARD / PRO のどれが合うかをお出しします。"
          ids={["diagnose"]}
        >
          <Diagnose />
        </DetailBlock>
        ...
        <DetailBlock
          label="発送と、問い合わせの中身を見る"
          note="発送依頼から伝票・追跡番号まで。AIがどこまで答え、どこから人へ渡すのかも含みます。"
          ids={["shipping", "ship", "support", "admin"]}
        >
          <Shipping />
          <AiSupport />
          <AdminConsole />
