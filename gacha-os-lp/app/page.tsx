  ...
  return (
    <>
      ...
      <main>
        ...
        <OperatingDay />
        {/*
          ★中の動画は「管理画面の録画」ではなくなりました（2026-08-22）。
            AIに伝える→承認→お客様が引く→発送依頼→AIが答える→
            判断が要るものは人へ→運営画面の数字が動く、までの31秒です。
            ラベルと説明を、中身と必ず一致させること。
            違うことを書いて開かせるのは、それだけで信用を落とします。
        */}
        <DetailBlock
          label="31秒で、作るところから遊ぶところまで見る"
          note="実際の画面を操作して録画した31秒と、本物の管理画面。誰が何をやるのかの役割分担も、ここにあります。"
