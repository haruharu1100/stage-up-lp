 ...
 *
 *   ★⑪を足した理由（2026-08-26、公開先で実際に起きました）。
 *     Next.js は、遠くのDBへのHTTPの問い合わせを
 *     「同じ問い合わせなら前の答えでいい」と覚えてしまいます。
 *     すると、DBには新しい値が入っているのに、
 *     画面はいつまでも古い値を出し続けます。
 *     本人確認が通らない、だけでは済みません。
 *     権限を外した担当者が、外す前の権限のまま通り、
 *     締め出したはずのアカウントが、まだ入れます。
 *     手元の検査（file:）はHTTPを通らないので、絶対に再現しません。
 *     だから「そう書いてあること」を、ここで見張ります。
 *
 * ═══════════════════════════════════════════════════════
 * ★1ファイルずつ、別々に動かしていること
 * ═══════════════════════════════════════════════════════
