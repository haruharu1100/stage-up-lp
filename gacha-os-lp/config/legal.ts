...
export const operator = {
   ...
   *
   * ★2026-09-01 変更：フォームだけの案内をやめ、メールアドレスを明記する。
   * 送る相手が法人なので、「窓口はフォームです」だけだと
   * 直接連絡する手段が無く、確認したい側が止まってしまう。
   * ここは実在し、実際に受信している 1 つのアドレスだけを書く。
   */
  contact: pick(
    process.env.NEXT_PUBLIC_OPERATOR_CONTACT,
    "info@morika.work（メール）／本サイトのご相談フォーム"
  ),
};
